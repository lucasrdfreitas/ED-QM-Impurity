...
{Lx,Ly}=Round@{Lx,Ly};eValues={};
	...
	Do[Module[{Himp,ev,JK },
		...
		Method -> {"Arnoldi","Criteria"->"RealPart","MaxIterations"->2000,"Tolerance"->10^-10}]);  ]];
		
		dataAppend[datapath,{JK,ev}];
		(*Print["    j=",j,"/",Length@KondoCouplings];Print["    Memory in use:  ",N[10^-9  MemoryInUse[] ]  ];*)
